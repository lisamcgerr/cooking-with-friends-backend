...
CookingSession.create(title: 'Enchailada Night', recipe_id: 1)
CookingSession.create(title: 'Family Cooking Night', recipe_id: 5)
CookingSession.create(title: 'Chicago Wednesday Night Cook Off', recipe_id: 7)
